...
model = load_model('C:/Users/LENOVO/OneDrive/Desktop/bird/BC.h5');
lab = {0: 'AFRICAN CROWNED CRANE', 1: 'AFRICAN FIREFINCH', 2: 'ALBATROSS',
       3: 'ALEXANDRINE PARAKEET', 4: 'AMERICAN AVOCET', 5: 'AMERICAN BITTERN', 6: 'AMERICAN COOT',
       7: 'AMERICAN GOLDFINCH', 8: 'AMERICAN KESTREL', 9: 'AMERICAN PIPIT', 10: 'AMERICAN REDSTART',
       11: 'ANHINGA', 12: 'ANNAS HUMMINGBIRD', 13: 'ANTBIRD', 14: 'ARARIPE MANAKIN',
       15: 'ASIAN CRESTED IBIS', 16: 'BALD EAGLE', 17: 'BALI STARLING', 18: 'BALTIMORE ORIOLE', 
       19: 'BANANAQUIT', 20: 'BANDED BROADBILL', 21: 'BAR-TAILED GODWIT', 22: 'BARN OWL', 
       23: 'BARN SWALLOW', 24: 'BARRED PUFFBIRD', 25: 'BAY-BREASTED WARBLER', 26: 'BEARDED BARBET', 
...
def run():
    img1 = Image.open('C:/Users/LENOVO/OneDrive/Desktop/bird/pic_circle.png')
    img1 = img1.resize((300,300))
    col1, col2, col3 = st.beta_columns([2,5,1])
    with col1:
        st.write("      ")
    with col2:
    ...
    st.markdown("")
    st.markdown("")
    st.markdown('''<h2 style='text-align: center; font-size: 70px; color:
                #FFF323;'>PAKSHI 🕊️</h2>''',unsafe_allow_html=True)
    st.markdown('''<h1 style='text-align: center; color: #FF5403;'>
                Birds Species Classification</h1>''',unsafe_allow_html=True)
    st.markdown('''<h2 style='text-align: left; color: #d73b5c;'>
                Choose an Image of Bird</h2>''',unsafe_allow_html=True)

    img_file = st.file_uploader(" ", type=["jpg", "png"])
    if img_file is not None:
        st.image(img_file,use_column_width=False)
        save_image_path = 'C:/Users/LENOVO/OneDrive/Desktop/bird/uploaded image/'+img_file.name
        ...
        if st.button("Predict"):
            ...
            st.title('To know more about this bird you can click on this following link :')
            st.write("(https://en.wikipedia.org/wiki/"+remove(result1)+")")
            
run()
#  streamlit run C:/Users/LENOVO/OneDrive/Desktop/bird/PROJECT.py [ARGUMENTS]